...
#define ACCEL_INT 2 // Define which GPIO pin the accelerometer INT1 pin is connected to. Change this to match your hardware
#define LED_PIN LED_BUILTIN // LED GPIO pin - change this if required
#define SD_CS 10 // SD Card Chip Select pin - change this if required
//#define SD_CS 5 // On the SparkFun ESP32 Thing Plus C, CS is pin 5
#define myWire Wire1 // Define which Wire port to use - change this if required
...
const int BATCH_SIZE = 3200;  // Number of data entries to accumulate before writing to SD
